          ...
          <div className="hero-body">
            <div className="columns is-flex-mobile is-centered">
              ...
              <h1 className="has-text-Black is-bold title font has-text-centered">Nice to meet you,</h1>
                <h2 className="has-text-Black-bold has-text-left font is-size-5"> Hi! I am Priya, I am a web developer/Tester  and this is my journey.
                 I will be writing about all the life experience and how it has been moulded so far in my 44 years of life.
                 It is been facinating, Intresting and Inspiring. I will start with one chapter of my life at a time and see how life takes place.
